...
<%@ page import="com.demo.utils.SortUtils" %>
<%--
...
<body>
    <div class="bg-secondary bg-gradient">
        ...
        <div class="container p-3">
            <!-- <a class="btn btn-lg btn-dark" href="/">Home Page</a> |  --><a class="btn btn-lg btn-dark" href="add">Add Customer</a>
        </div>
    </div>
    <div class="container mt-5">
        <c:choose>
                    ...
                    <tbody>
                        <c:forEach var="customer" items="${customers}">
                            <tr>
                                ...
                                <td><a href="update?id=${customer.id}">Update</a> | <a class="delete" href="delete?id=${customer.id}" onclick="return confirm('Do you really want to delete this?')">Delete</a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
                </table>
            ...
            <c:otherwise>
                ...
                <a href="list" class="btn btn-primary btn-lg mt-5">See Customer List</a>
            </c:otherwise>
        </c:choose>
    </div>
</body>
